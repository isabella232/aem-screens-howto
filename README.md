...
[ml-facedetection](usecases/ml-facedetection/)|A *smart* sequence channel that uses ML-trained models to target content based on facial features such as age, gender and mood *(original contribution by @LU15W1R7H)*
